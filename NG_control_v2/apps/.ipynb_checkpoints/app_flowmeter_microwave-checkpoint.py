	...
	[
		...
		html.Div(
			[
				...
				html.Div(id='microwave-power-setpoint'), # Hidden div inside the app that stores the setpoint power data
				html.Div(id='microwave-frequency-setpoint'), # Hidden div inside the app that stores the setpoint frequency data
				...
				html.Div(id='microwave-rf-onOff') # Hidden div inside the app that stores if the RF is turned on or off
